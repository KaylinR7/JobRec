...
/**
 * Custom adapter for filter dropdowns that shows the count of matching candidates
...
/**
 * Data class representing a filter option with a count of matching candidates.
 */
